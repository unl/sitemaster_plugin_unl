...
class MetricTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function getHTMLVersion()
    {
        ...
        $this->assertEquals('5.3', $metric->getHTMLVersion($xpath_template_5_3));
    ...
    public function getDEPVersion()
    {
        ...
        $this->assertEquals('5.3.1', $metric->getDEPVersion($xpath_template_5_3));
    ...
    public function getYouTubeEmbeds()
    {
        ...
        $xpath_template = $this->getTestXPath('template_5_3.html');
    ...
    public function getBrandInconsistencies()
    {
        ...
        $xpath_template = $this->getTestXPath('template_5_3_unl.html');
